  ...
  <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-hide-on-scroll navbar-brand-center" style="background-color: #e0ffff;box-shadow: 0px 2px 30px 2px rgba(0, 0, 0, 0.1);">
    <div class="navbar-wrapper">
      ...
      <div class="navbar-header">
        ...
        <a class="nav-link" href="javascript:void(0)"><img class="brand-logo" style="width:180px;height:40px;" alt="modern admin logo" src="app-assets/images/logo/logo.png">
        </a>
        </li>
      ...
      <li class="nav-item smallllll">
         <a class="nav-link" href="index.php"> <img class="brand-logo" style="width:180px;height:40p;margin-left: 20px;" alt="modern admin logo" src="app-assets/images/logo/logo.png">
        </a>
         </li>
  ...
  $(".nav-link-all").on('mouseleave',function(){
   ...
   $(this).children('.nav-icon-all').css({"color":"#009bea"});
                              ...
                              <a class="dropdown-item">
                               <span class="mr-1">Virtual Labs <sub><span class="badge badge-success"><b>Beta</b></span></sub>
                            </span>
                            </a>
              ...
              <!-- <a class="dropdown-toggle nav-link dropdown-user-link header-link nav-link-all" id="nav-link-about" href="../about.php" data-toggle="dropdown" style="padding-left: 15px;">
                <span class="mr-1 nav-text" style="font-weight: 450;">About-us
                </span>
              </a> -->

              <a class="dropdown-toggle nav-link dropdown-user-link header-link nav-link-all" href="about.php" style="padding-left: 15px;">
                <span class="mr-1 nav-text" style="font-weight: 450;">About Us</span></a>
            </li>
            ...
            <li class="dropdown dropdown-user nav-item commonmobile">
              <a class="dropdown-toggle nav-link dropdown-user-link header-link nav-link-all" href="#" data-toggle="dropdown" style="padding-left: 15px;">
                <span class="mr-1 nav-text" style="font-weight: 450;">Develop a Lab
                </span>
              </a>
              <div class="dropdown-menu dropdown-menu-right nav-submenu-mobile-class" id="nav-submenu-mobile"><a class="dropdown-item nav-text nav-link-all" href="auth/login.php"><i class="la la-edit nav-text nav-icon-all"></i><span class="mr-1 nav-text" style="font-weight: 450;"> Propose a new Lab</span></a>
...
<!-- Workshop menu-->
	   ...
	   <li class="dropdown dropdown-user nav-item commonmobile">
		...
		<!--<a target="_blank" class="dropdown-item nav-text nav-link-all" href="nitk_labs.php"><i class="la la-edit nav-text nav-icon-all" ></i><span class="mr-1 nav-text" style="font-weight: 450;">NITK Labs for evaluation</span></a> -->
          ...
          <!-- <li class="dropdown dropdown-user nav-item commonmobile">
              ...
              <div class="dropdown-menu dropdown-menu-right nav-submenu-mobile-class" id="nav-submenu-mobile">
              	<a target="_blank" class="dropdown-item nav-text nav-link-all" href="http://vlabs.iitb.ac.in/bootcamp/"><i class="la la-edit nav-text nav-icon-all"></i><span class="mr-1 nav-text" style="font-weight: 450;"> BootCamp Marwadi</span></a>
	...
	<li class="dropdown dropdown-user nav-item commonmobile">
	 ...
	 <!--   <li class="dropdown dropdown-user nav-item commonmobile">
	    ...
	    <!-- <li class="dropdown dropdown-user nav-item commonmobile">
              <a class="dropdown-toggle nav-link dropdown-user-link header-link nav-link-all" href="http://9m.io/0Bzg/"  target="_blank" style="padding-left: 15px;">
                <span class="mr-1 nav-text" style="font-weight: 450;">BootCamp
                </span>
              </a>
            </li> -->
